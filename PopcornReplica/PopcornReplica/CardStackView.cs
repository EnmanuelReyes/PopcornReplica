...
namespace PopcornReplica
{
	public class CardStackView : ContentView
	{
		...
		//public static readonly BindableProperty LeftCommandProperty = BindableProperty.Create("LeftCommand", typeof(ICommand), typeof(Button), null);
		//public static readonly BindableProperty RightCommandProperty = BindableProperty.Create("RightCommand", typeof(ICommand), typeof(Button), null);
